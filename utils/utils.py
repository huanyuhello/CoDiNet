...
def parse_system(args):
    ...
    hyper_param_str = '_%s_%s_beta_%d_%s_%s_w_%.5f_l_%.3f_num_%d' % (
        args.backbone, args.dataset, args.beta, args.block_type,
        args.gate_type, args.loss_w, args.loss_lda, args.num_target)
    if args.finetune:
        hyper_param_str += '_finetune'
